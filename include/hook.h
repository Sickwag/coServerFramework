...
/**
 * @brief Whether syscall hooking is enabled for the current thread.
 */
bool isHookEnable();
...
typedef ssize_t (
	*sendto_fun)(int s, const void* msg, size_t len, int flags, const struct sockaddr* to, socklen_t tolen);
